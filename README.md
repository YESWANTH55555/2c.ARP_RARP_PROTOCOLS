...
## ALGORITHM:
1.ead destination IP address.

2.Search ARP table for matching IP.

3.If IP is found, get corresponding MAC address.

4.Otherwise, send ARP request broadcast# 2c.SIMULATING ARP /RARP PROTOCOLS
## AIM
To write a python program for simulating ARP protocols using TCP.
## ALGORITHM:
## Client:
...
5.Display MAC address and stop.
